		...
		<div id="header">
			...
			<div class="menu">
				<ul>
					...
					<li style="width: 80px ; text-align:center;" ><img src="${pageContext.request.contextPath}/images/Female.gif" alt="" /><a href="${pageContext.request.contextPath}/user/user_info.jsp" target="_parent">个人信息</a></li>
